...
export const api = {
  ...
  adminCampaignsMeta: () => G<any>('/admin/campaigns-meta'),
  adminCampaign: (id: string) => G<any>(`/admin/campaigns/${id}`),
  adminCreateCampaign: (b: any) => P<any>('/admin/campaigns', b),
  adminUpdateCampaign: (id: string, b: any) => PUT<any>(`/admin/campaigns/${id}`, b),
  adminCampaignAudience: (id: string) => P<any>(`/admin/campaigns/${id}/audience`),
  adminPreviewAudience: (audiences: string[]) => P<any>('/admin/campaigns/preview/audience', { audiences }),
  adminSendCampaign: (id: string) => P<any>(`/admin/campaigns/${id}/send`),
  adminProcessDueCampaigns: () => P<any>('/admin/campaigns/process-due'),
  ...
  adminContactMessages: () => G<any>('/site/admin/messages'),
  adminMarkMessageRead: (id: string) => P<any>(`/site/admin/messages/${id}/read`),
  // Communications — user-facing
  broadcasts: () => G<any>('/comms/broadcasts'),
  markBroadcastRead: (id: string) => P<any>(`/comms/broadcasts/${id}/read`),
  markAllBroadcastsRead: () => P<any>('/comms/broadcasts/read-all'),
  supportChat: () => G<any>('/comms/chat'),
  sendSupportChat: (body: string) => P<any>('/comms/chat/messages', { body }),
  supportChatUnread: () => G<any>('/comms/chat/unread'),
  // Communications — admin
  adminBroadcasts: () => G<any>('/admin/comms/broadcasts'),
